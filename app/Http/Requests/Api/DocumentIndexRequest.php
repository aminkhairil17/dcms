...
class DocumentIndexRequest extends FormRequest
{
    ...
    public function getCategory(): string { return trim((string) ($this->validated('category', ''))); }
    public function getStatus(): string { return trim((string) ($this->validated('status', ''))); }
    public function getSortBy(): string { return $this->validated('sortBy', 'created_at'); }
    public function getOrder(): string  { return $this->validated('order', 'desc'); }
}
