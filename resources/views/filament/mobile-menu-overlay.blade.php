...
$menuGroups = [
    ...
    [
        ...
        'items' => array_filter([
            ...
            $isSuperAdmin ? ['label' => 'Activity Log', 'url' => url("/{$panelPath}/activity-logs"),       'icon' => 'activity_log', 'color' => '#475569'] : null,
            $isSuperAdmin ? ['label' => 'Audit Trail',  'url' => url("/{$panelPath}/audit-trail"),         'icon' => 'audit',     'color' => '#64748b'] : null,
        ]),
    ],
];
@endphp
